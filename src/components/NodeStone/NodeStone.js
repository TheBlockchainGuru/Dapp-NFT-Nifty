            ...
            <div className="nodeStone__main">
                ...
                <div className="container">
                    ...
                    <div className="nodeStone__main__content">
                        Nodestones are randomly minted on the Ethereum blockchain using 39 possible traits. Nodstones place you into 1 of 5 realms and act as a future minting pass. There are also 5 1:1 Nodestones hidden in the mint. All Nodestones are minted randomly by Fair Distribution at 0.1 ETH
                    </div>
                </div>
            </div>
        </section>
